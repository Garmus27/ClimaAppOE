...
# iteracion para volver a ejecutar el loop
def pregunta(valor2):
    ...
    while True:
        print("desea volver a ingresar ciudad, s/n?")
        v = input().lower() # para que no distinga entre mayusculas y minusculas
...
while valor == False: # mientras el valor obtenido de la funcion pregunta() sea falso seguira preguntando
